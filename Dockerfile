...
RUN apk add --no-cache curl git bash make gcc g++ binutils-gold python linux-headers paxctl libgcc libstdc++ gnupg && \
  ...
  apk del make gcc g++ binutils-gold python linux-headers paxctl gnupg ${DEL_PKGS} && \
